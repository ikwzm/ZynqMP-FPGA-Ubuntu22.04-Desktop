...
#### Install Ubuntu 22.04(Console) to Ultra96/Ultra96-V2/Kv260

 * [Ultra96](https://github.com/ikwzm/ZynqMP-FPGA-Ubuntu22.04-Console/blob/v1.0.0/doc/install/ultra96-console.md)
 * [Ultra96-V2](https://github.com/ikwzm/ZynqMP-FPGA-Ubuntu22.04-Console/blob/v1.0.0/doc/install/ultra96v2-console.md)
 * [Kv260](https://github.com/ikwzm/ZynqMP-FPGA-Ubuntu22.04-Console/blob/v1.0.0/doc/install/kv260-console.md)
...
shell# (cat ZynqMP-FPGA-Ubuntu22.04-Console-1.0.0/ubuntu22.04-console-rootfs.tgz.files/*) | tar xfz - -C $PWD/$targetdir
shell# cp files/*.deb     $PWD/$targetdir/home/fpga/debian
